...
export const ENHANCED_PINECONE_DATA = [
  ...
  },
  {
    ...
    content:
      "Beyond the MERN stack, I'm skilled in TypeScript for type-safe development, Redux Toolkit and Zustand for state management, and Tailwind CSS for modern, responsive styling. I have experience with React Native for cross-platform mobile development, Next.js for server-side rendering and static site generation, and modern development tools including Webpack, Vite, Docker, and CI/CD pipelines. I'm also proficient in data structures, algorithms, and have a strong foundation in competitive programming.",
    keywords: [
      "TypeScript",
      "Redux Toolkit",
      "Zustand",
  ...
  },
  {
    ...
    content:
      "At Examroom.ai, I work on cutting-edge educational technology solutions, developing interactive learning platforms and comprehensive assessment tools. My responsibilities include building user-friendly interfaces for students and educators, optimizing application performance for seamless user experience, implementing real-time features like live chat and collaborative tools, and working on both frontend React applications and backend Node.js services. I focus on creating scalable solutions that enhance the learning experience for thousands of users.",
    keywords: [
      "Examroom.ai",
  ...
  },
  {
    ...
    relevance_boost: 1.4,
    project_links: {
      github: "https://github.com/Ankit91153/studynotion",
      demo: "https://studynotion-lemon.vercel.app/",
    },
  },
  {
    id: 6,
    ...
    relevance_boost: 1.3,
    project_links: {
      github: "https://github.com/Ankit91153/ai-generator-content",
      demo: "https://ai-generator-content-rbtq.vercel.app/",
    },
  },
  {
    id: 7,
    ...
    relevance_boost: 1.1,
    project_links: {
      github: "https://github.com/Ankit91153/blog-frontend",
      demo: "https://ankit-verse.vercel.app/",
    },
  },
  {
    id: 8,
    topic: "guess_number_game_project",
    content:
      "Guess Number Game is an interactive web game where users try to guess a random number generated by the computer in the range 1-100 with minimum guesses. Built with vanilla JavaScript, HTML5, and CSS3, it demonstrates fundamental programming concepts like random number generation, user input validation, and game logic implementation. The project showcases clean UI design and responsive gameplay mechanics.",
    keywords: [
      "Guess Number Game",
      "interactive game",
      "random number",
    ...
    category: "projects",
    priority: "medium",
    context_type: "portfolio_project",
    relevance_boost: 1.0,
    project_links: {
      github: "https://github.com/Ankit91153/Number-Guesses-Game",
      demo: "https://ankit91153.github.io/Number-Guesses-Game/",
    },
  },
  {
    id: 9,
    topic: "ecommerce_cart_project",
    content:
      "Add-To-Cart is a shopping cart application built with React and Redux Toolkit, demonstrating modern state management and e-commerce functionality. The app features product browsing, cart management, quantity updates, and responsive design. It showcases proficiency in React hooks, Redux state management, and modern JavaScript ES6+ features for building scalable e-commerce solutions.",
    keywords: [
      "Add-To-Cart",
      "shopping cart",
      "React",
    ...
    relevance_boost: 1.0,
    project_links: {
      github: "https://github.com/Ankit91153/e-commerce-website",
      demo: "https://e-commerce-website-react-nine.vercel.app/",
    },
  },
  {
    id: 10,
    topic: "weather_app_project",
    content:
      "Weather Website is a real-time weather application that displays current weather conditions for any given location. Built with JavaScript and weather APIs, it features geolocation integration, responsive design, and clean UI for optimal user experience. The project demonstrates API integration skills, asynchronous JavaScript, and modern web development practices.",
    keywords: [
      "Weather Website",
      "real-time weather",
      "weather API",
    ...
    relevance_boost: 1.0,
    project_links: {
      github: "https://github.com/Ankit91153/weatherApp",
      demo: "https://weather-app-by-ankit.onrender.com/",
    },
  },
  {
    id: 11,
    topic: "netflix_clone_project",
    content:
      "Netflix Clone is a front-end replica of the popular streaming platform featuring responsive UI, movie browsing interface, and video player integration. Built with HTML5, CSS3, and JavaScript, it demonstrates advanced CSS techniques, responsive design principles, and modern web development skills. The project showcases ability to recreate complex user interfaces with attention to detail.",
    keywords: [
      "Netflix Clone",
      "streaming platform",
      "responsive UI",
    ...
    relevance_boost: 1.0,
    project_links: {
      github: "https://github.com/Ankit91153/netflixClone",
      demo: "https://ankit91153.github.io/netflixClone/",
    },
  },
  {
    id: 12,
    topic: "youtube_lite_project",
    content:
      "YouTube Lite is a front-end clone of YouTube featuring video browsing interface, search functionality, and responsive design. Built in 2023, this project recreates the familiar YouTube user experience with modern web technologies. It demonstrates proficiency in creating complex layouts, implementing search features, and building scalable front-end applications.",
    keywords: [
      "YouTube Lite",
      "YouTube clone",
      "video browsing",
    ...
    relevance_boost: 1.0,
    project_links: {
      github: "https://github.com/Ankit91153/youTube-Lite",
      demo: "https://you-tube-lite.netlify.app",
    },
  },
  {
    id: 13,
    topic: "addnote_app_project",
    content:
      "AddNote is a sleek note-taking application built with the MERN stack featuring user authentication, real-time updates, and cloud synchronization. The app demonstrates proficiency in full-stack development with secure user management, responsive design, and modern JavaScript frameworks. It showcases skills in React.js, Node.js, Express, and MongoDB integration.",
    keywords: [
      "AddNote",
      "note-taking app",
      "MERN stack",
    ...
    relevance_boost: 1.0,
    project_links: {
      github: "https://github.com/Ankit91153/mininotesforntend",
      demo: "https://mininotesapp.netlify.app/",
    },
  },
  {
    id: 9,
  ...
  },
  {
    ...
    keywords: [
      "GitHub",
      "github.com/Ankit91153",
      "code repositories",
      "open-source projects",
      "LinkedIn",
      "linkedin.com/in/ankit-kumar-pandey-36b72220b",
  ...
  },
  {
    ...
    content:
      "When approaching technical challenges, I follow a systematic methodology: first, I thoroughly understand the problem requirements and constraints; then I research existing solutions and best practices; next, I design a scalable architecture considering future growth; I implement the solution using clean, well-documented code; finally, I test comprehensively and optimize for performance. I believe in breaking down complex problems into smaller, manageable components and using appropriate design patterns. I'm experienced in debugging complex issues, performance bottlenecks, and implementing monitoring and logging systems. My approach emphasizes maintainability, scalability, and team collaboration throughout the development process.",
    keywords: [
